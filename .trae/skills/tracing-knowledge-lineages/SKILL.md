...
2. **Search project memory** with `manage_core_memory` or review known project notes
...
2. **Project memory and current notes** (use `manage_core_memory` and repository docs)
